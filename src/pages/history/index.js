                        ...
                        <Col xs={12} sm={6} xl={4}>
                            <div className="ltn__feature-item ltn__feature-item-7 ltn__feature-item-7-color-white">
                                <div className="ltn__feature-icon-title">
                                    ...
                                    <h3 className="animated fadeIn"><Link href="https://maraseqgroup.com/service/buy-a-home">The Perfect Residency</Link></h3>
                                </div>
                        ...
                        <Col xs={12} sm={6} xl={4}>
                            <div className="ltn__feature-item ltn__feature-item-7 ltn__feature-item-7-color-white">
                                <div className="ltn__feature-icon-title">
                                    ...
                                    <h3 className="animated fadeIn"><Link href="https://maraseqgroup.com/service/buy-a-home">Global Architect Experts</Link></h3>
                                </div>
                                <div className="ltn__feature-info">
                                    <p>Lorem ipsum dolor sit ame it, consectetur adipisicing elit, sed do eiusmod te mp or incididunt ut labore.</p>
                                </div>
                        ...
                        <Col xs={12} sm={6} xl={4}>
                            <div className="ltn__feature-item ltn__feature-item-7 ltn__feature-item-7-color-white">
                                <div className="ltn__feature-icon-title">
                                    ...
                                    <h3 className="animated fadeIn"><Link href="https://maraseqgroup.com/service/buy-a-home">Built-in Storage Cupboards</Link></h3>
                                </div>
                                <div className="ltn__feature-info">
                                    <p>Lorem ipsum dolor sit ame it, consectetur adipisicing elit, sed do eiusmod te mp or incididunt ut labore.</p>
                                </div>
                    ...
                    <Row>
                        <Col xs={12}>
                            <div className="call-to-action-inner call-to-action-inner-5 text-decoration text-center">
                                <h2 className="white-color">24/7 Availability, Make <Link href="https://maraseqgroup.com/team/kelian-anderson">An Appointment</Link></h2>
                            </div>
                        </Col>
                    </Row>
                </Container>
